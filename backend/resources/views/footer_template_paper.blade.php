...
<div class="flexrow">
    <div>
        <svg version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" width="16px" height="16px" viewBox="0 0 100.354 100.352" style="enable-background:new 0 0 100.354 100.352;" xml:space="preserve">
            <path d="M93.09,76.224c0.047-0.145,0.079-0.298,0.079-0.459V22.638c0-0.162-0.032-0.316-0.08-0.462
                ...
                l25.243,23.002H12.309L37.436,51.132z M64.778,49.232L90.169,26.04v46.33L64.778,49.232z" id="id_103" style="fill: #4d9eb9;"></path>
        </svg>
        <span>contato@advogadossc.com</span>
    </div>
    <div>
        <span>Solu&ccedil;&otilde;es Jur&iacute;dicas Descomplicadas</span>
    </div>
    <div>
        <svg version="1.1" id="Layer_2" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" width="16px" height="16px" viewBox="0 0 64 64" enable-background="new 0 0 64 64" xml:space="preserve">
            <path fill="none" stroke="#4d9eb9" stroke-width="2" stroke-miterlimit="10" d="M32.001,0.887c17.184,0,31.113,13.929,31.112,31.113
                C63.114,49.185,49.184,63.115,32,63.113C14.815,63.114,0.887,49.185,0.888,32.001C0.885,14.816,14.815,0.887,32.001,0.887z" id="id_108"></path>
            <line fill="none" stroke="#4d9eb9" stroke-width="2" stroke-miterlimit="10" x1="32" y1="1" x2="32" y2="63" id="id_109"></line>
            <line fill="none" stroke="#4d9eb9" stroke-width="2" stroke-miterlimit="10" x1="63" y1="32" x2="1" y2="32" id="id_110"></line>
            <path fill="none" stroke="#4d9eb9" stroke-width="2" stroke-miterlimit="10" d="M30,1c0,0-14,11-14,31s14,31,14,31" id="id_111"></path>
            <path fill="none" stroke="#4d9eb9" stroke-width="2" stroke-miterlimit="10" d="M34,1c0,0,14,11,14,31S34,63,34,63" id="id_112"></path>
            <path fill="none" stroke="#4d9eb9" stroke-width="2" stroke-miterlimit="10" d="M8,12c0,0,5,10,24,10s24-10,24-10" id="id_113"></path>
            <path fill="none" stroke="#4d9eb9" stroke-width="2" stroke-miterlimit="10" d="M8,52c0,0,5-10,24-10s24,10,24,10" id="id_114"></path>
        </svg>
        <span>advogadossc.com</span>
    </div>
</div>
